...
class GridForecast(ForecastingBase):
    """
    Forecast grid power import using the trained Random Forest model.
    """
    ...
    def preprocess(
        ...
        """
        Convert the incoming grid state into a model-ready DataFrame.
        """
    ...
    def predict(
        ...
        """
        Predict the next grid target value.
        """
    ...
    def forecast(
        ...
        """
        Generate a grid forecast from the current state.
        """
